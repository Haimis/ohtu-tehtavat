...
public class Stepdefs {
    ...
    @When("a correct username {string} and valid password {string} but unmatching password confirmation are entered")
    public void aCorrectUsernameAndValidPasswordButUnmatchingPasswordConfirmationAreEntered(String username, String password) {
        ...
        element.sendKeys(password+"sasdas");
        element = driver.findElement(By.name("signup"));
        element.submit();
    }

    @When("a correct username {string} and correct password {string} and matching password confirmation are entered")
    public void aCorrectUsernameAndCorrectPasswordAndMatchingPasswordConfirmationAreEntered(String username, String password) {
        logInWith(username, password);
    }

    @When("a incorrect username {string} and incorrect password {string} and matching password confirmation are entered")
    public void aIncorrectUsernameAndIncorrectPasswordAndMatchingPasswordConfirmationAreEntered(String username, String password) {
        logInWith(username, password);
    }
    ...
    public void nonexistentAndPasswordAreGiven(String username, String password) {
        logInWith(username, password);
    }    
